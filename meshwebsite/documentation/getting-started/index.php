                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            ...
                            <p>meshBuilder is an extremley powerful tool allowing you to set variables before downloading the compiled CSS. You can adjust a vast amount of different variables to suit your needs, including but not limited to: 
                                <br>Grid breakpoints, colors (and attributes), spacing sizes (padding & margin), position properties, font sizes and a lot more.</p>
                            <p>Not only that, but you can choose to eliminate any utilities or components you may not use in your project. This ultimatley makes things extremley fast and your css becomes a lot less bloated without the need to download our scss files.</p>
