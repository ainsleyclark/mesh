        ...
        <div class="row justify-content-center mt-4 mt-desk-5">
            <div class="col-12 col-tab-9 col-desk-8 mr-desk-2 px-desk-4">
                ...
                <article class="section-scroll" id="whatIs">
                    ...
                    <p>mesh (pronounced /meʃ/) is an open source pure CSS framework for building websites for efficiently. Unlike other frameworks, you can use mesh without detracting from the unique visual signature of a website, whilst still being able to add components to accelerate your workflow.</p>
                    <p>IL has a modular approach to a responsive layout system. You can define containers, rows and columns and set them independently of screen width. Five breakpoints let you sculpt your site to different screen sizes and an easy naming system makes it ideal for beginners or patrons of the web.</p>
                ...
                <article class="section-scroll" id="download">
                    ...
                    <div class="row my-3">
                        <div class="col-12">
                            ...
                            <p>Not only that, but you can choose to eliminate any utilities or components you may not use in your project. This ultimately makes things extremely fast and your css becomes much less bloated without the need to download our scss files.</p>
