    ...
    <div class="container-fullwidth">
        <div class="row justify-content-center mt-4 mt-desk-5">
            <div class="col-12 col-tab-9 col-desk-8 mr-desk-2 px-desk-4">
                ...
                <!-- Small -->
                <label for="smallModal" class="btn btn-secondary nohover c-white">Small</label>
                ...
                <!-- Large -->
                <label for="largeModal" class="btn btn-secondary nohover c-white">Large</label>
                ...
                <!-- Scrolling Content -->
                <label for="scrollingModal" class="btn btn-secondary nohover c-white">Scrolling Content</label>
                ...
                <div class="modal" aria-hidden="true">
                    <div class="modal-container">
                        ...
                        <div class="modal-body">
                            ...
                            <p>"Try to watch your thoughts and see how they come and go. Stay in the quietness that arises. The moments of peace will be brief at first, but in time they will get longer. This peace is also strength, power, kindness, and love. In time, you will realize that you are one with the Universal Power, and this will lead you to act from a different dimension - point of view -consciousness, not from the selfish, small, limited ego."</p>
                            ...
                            <p>"Being good and being kind do not necessarily point to weakness. When you are good, you can also be strong. People sense your inner strength, and therefore, do not impose on you. When you are strong and calm inside, you help people, because you can, and you want to. You act from strength, not from weakness. Goodness is not a sign of weakness, as some people erroneously think. It can manifest together with power and strength."</p>
