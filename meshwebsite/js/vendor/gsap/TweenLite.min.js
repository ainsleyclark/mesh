		...
		Q = function(a, b, c, d) {
			...
			for (l.start = a, l.end = b, a = l[0] = a + '', b = l[1] = b + '', c && (c(l), (a = l[0]), (b = l[1])), l.length = 0, e = a.match(M) || [], f = b.match(M) || [], d && ((d._next = null), (d.blob = 1), (l._firstPT = l._applyPT = d)), i = f.length, h = 0; i > h; h++)
				(k = f[h]),
					...
					k === e[h] || e.length <= h ? (n += k) : (n && (l.push(n), (n = '')), (g = parseFloat(e[h])), l.push(g), (l._firstPT = { _next: l._firstPT, t: l, p: l.length - 1, s: g, c: ('=' === k.charAt(1) ? parseInt(k.charAt(0) + '1', 10) * parseFloat(k.substr(2)) : parseFloat(k) - g) || 0, f: 0, m: o && 4 > o ? Math.round : P })),
					(m += k.length)
		...
		R = function(a, b, c, d, e, f, g, h, i) {
			...
			return (
				('number' != typeof m || ('number' != typeof d && !n)) &&
					(g || isNaN(m) || (!n && isNaN(d)) || 'boolean' == typeof m || 'boolean' == typeof d ? ((o.fp = g), (j = Q(m, n ? parseFloat(o.s) + o.c + (o.s + '').replace(/[0-9\-\.]/g, '') : d, h || H.defaultStringFilter, o)), (o = { t: j, p: 'setRatio', s: 0, c: 1, f: 2, pg: 0, n: e || b, pr: 0, m: 0 })) : ((o.s = parseFloat(m)), n || (o.c = parseFloat(d) - o.s || 0))),
